...
namespace ClientWpf
{
    public partial class MainWindow : Window
    {
        ...
        private void SendButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ListBoxMess.Items.Add(($"[{DateTime.Now:HH:mm}] Me: {TextBoxMessage.Text}"));   
            TextBoxMessage.Text = "";            
        }
        private void Grid_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                client.SendMessage((string)ChatWithName.Content, TextBoxMessage.Text);
                _ = ListBoxMess.Items.Add($"[{DateTime.Now:HH:mm}] Me: {TextBoxMessage.Text}");
                TextBoxMessage.Text = "";
            }        
        }
        private void CreateChatButton_Click(object sender, RoutedEventArgs e)
        {
            ChatCreator chatCreateWindow = new ChatCreator();
            chatCreateWindow.ShowDialog();
        }
