...
namespace task3
{
    class Program
    {
        ...
        public static void ShowInfoUser(SqlConnection connection, string sqlExpression)
        {
        ...
        public static void ShowInfoMessages(SqlConnection connection, string sqlExpression)
        {
            SqlCommand command = connection.CreateCommand();
            command.CommandText = sqlExpression;
            SqlDataAdapter mySqlDataAdapter = new SqlDataAdapter();
        ...
        public static void ShowInfoMessagesContent(SqlConnection connection, string sqlExpression)
        {
            SqlCommand command = connection.CreateCommand();
            command.CommandText = sqlExpression;
            SqlDataAdapter mySqlDataAdapter = new SqlDataAdapter();
        ...
        static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                ShowInfoUser(connection, sqlExspressionUsers);
                ShowInfoMessages(connection, sqlExspressionMessages);
                ShowInfoMessagesContent(connection, sqlExspressionMessagesContent);
            }
